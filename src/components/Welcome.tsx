    ...
    try {
      ...
      if (userSnap.exists()) {
        ...
        if (userData.isBanned) {
          // Don't sign out here - let page.tsx detect banned status and show BannedPage
          // This prevents the UI flickering issue where banned page briefly shows then disappears
          setIsLoading(false);
          return;
        }
      }
